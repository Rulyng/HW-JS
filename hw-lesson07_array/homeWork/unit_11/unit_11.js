...
function f8() {
   ...
   ar = document.querySelector('.i-8').value;
   for(i = d8.length - 1; i >=0; i--){
    d8[i + 1] = d8[i];
   }
   d8[0] = ar;
    showArr('.out-8', d8);
...
let num12 = +document.querySelector('.i-12').value;
...
let d19 = ['Your', 'pdddddddayment', 'method', 'will', 'automatically', 'be', 'charged', 'in', 'advance', 'every'];
let maxString = '';
