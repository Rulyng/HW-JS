...
document.querySelector('.out-9').innerHTML = task9;
...
document.querySelector('.out-10').innerHTML = task10 * 20;
}
...
document.querySelector('.out-11').innerHTML = task11 + 55;
}
...
function t12() {
let task12_1 = document.querySelector('.i-12-1').value;
let task12_2 = document.querySelector('.i-12-2').value;
document.querySelector('.out-12').innerHTML = `Hello ${task12_1} ${task12_2}`
...
// Task 16.
//По нажатию на кнКопку .b-16 выполняется функция t16. Функция получает из .i-16-1 и i-16-2 числа. Выведите в .out-16 сумму данных чисел по нажатию кнопки b-16. Не переводите полученное из input в число!!!!

function t16() {
    let a = parseInt(document.querySelector('.i-16-1').value);
    let b = parseInt(document.querySelector('.i-16-2').value);
...
// document.querySelector('.out-16').innerHTML = parseInt(a) + parseInt(b);
}
...
function t19() {
    let a = parseInt(document.querySelector('.i-19-1').value);
    let b = parseInt(document.querySelector('.i-19-2').value);
